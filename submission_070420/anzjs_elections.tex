...
From 2007 onwards, the percentage of people in both marriages (\texttt{Married}) and de facto relationships (\texttt{DeFacto}) were found to be strong predictors of the two-party preferred vote in favour of the Labor party. In 2001 and 2004 neither of these variables were significant (see rows 4 and 5 in Figure \ref{fig:partresplot2}).
