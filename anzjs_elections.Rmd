...
ggplot(data = hume_area16) +
  ...
  guides(alpha = FALSE, col = FALSE, 
    fill = guide_legend(override.aes = list(col = c("grey50", NA), alpha = 0.4)))
```
