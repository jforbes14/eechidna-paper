...
There are $p=33$ variables in the resultant set obtained from this procedure. One of the age brackets (`Pop_55_plus`) is removed from this set to avoid multicollinearity, because the other three age brackets are included. Hence, the final predictor set contains $p=32$ variables. 
