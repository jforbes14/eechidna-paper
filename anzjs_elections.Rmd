...
The paper is organised as follows. Section \@ref(data) describes the data collection, joining and cleaning, while model details are discussed in Section \@ref(modelling). Section \@ref(results) describes the inference conducted to determine significance of effects and how these change over time. Section \@ref(conclusion) summarises the work. Two supplementary sections document the contributions of others to this work and the software.
