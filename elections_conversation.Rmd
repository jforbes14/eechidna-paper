...
```{r timeline, echo = FALSE, fig.cap="Timeline of Australian elections and Censuses. Censuses happen regularly, elections not quite regularly, which means data needs to be interpolated by time.", out.width = "90%", fig.align="center"}
