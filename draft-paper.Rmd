...
auscitizen_ex <- abs2016 %>%
  ...
  mutate(
    `Estimated Population Allocated to Purple Region` = c(21, 548, 16358, 474, 86, 145427, 39117, 92),
...
stargazer::stargazer(glsmod01, glsmod04, glsmod07, glsmod10, glsmod13, glsmod16,
  header = FALSE,
...
grid.arrange(p7, p8, p9, p10, p11, p12, p13,
  nrow = 7,
