...
Electorate (2016) | Percentage | Population | Estimated Population Allocated to Purple Region: $\hat{P}_{s,t}$
--------------------|----------|-----------|---------------------------------------------
...
Table 3 details the resultant estimated model coefficients and their estimated standard errors for each of the six elections. These are interpreted in the next section.
...
```{r rhovis, fig.cap="Estimates of the spatial autoregressive parameter for each of the six elections, with a 95\\% confidence interval. Only in 2001 and 2016 is there a significant spatial component", out.height='15%', out.extra = ''}
