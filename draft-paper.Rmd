...
```{r partresplot1, fig.cap = "Partial residual plots for: Incomes, Unemployment, Extractive, Transformative, ManagerAdmin and DiffAddress", fig.height = 9,  fig.width = 6, warning = F, fig.pos = 'h'}
...
```{r partresplot2, fig.cap = "Partial residual plots for: DeFacto, MedianAge, Education, OtherLanguage, BornSEEuro, BornAsia and Judaism.", fig.height = 9,  fig.width = 6, warning = F, fig.pos = 'h'}
