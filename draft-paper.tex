...
{\centering \includegraphics[width=0.9\linewidth]{skeleton_files/figure-latex/timeline-1} 
...
\hypertarget{applied}{%
\subsubsection{Applied}\label{applied}}
...
{\centering \includegraphics[height=0.3\textheight]{skeleton_files/figure-latex/hume13-1} 
...
{\centering \includegraphics[height=0.3\textheight]{skeleton_files/figure-latex/hume16-1} 
...
{\centering \includegraphics[height=0.15\textheight,]{skeleton_files/figure-latex/rhovis-1} 
...
{\centering \includegraphics[height=0.15\textheight,]{skeleton_files/figure-latex/plotintercept-1} 
...
{\centering \includegraphics[width=0.8\linewidth,]{skeleton_files/figure-latex/resstate-1} 
...
{\centering \includegraphics{skeleton_files/figure-latex/partresplot1-1} 
...
{\centering \includegraphics{skeleton_files/figure-latex/partresplot2-1} 
