...
```{r rhovis, out.height= "15%", fig.cap = "Estimates of the spatial autoregressive parameter for each of the six elections, with a 95% confidence interval. Only in 2001 and 2016 is there a significant spatial component."}
