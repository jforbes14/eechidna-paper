...
\begin{center}\includegraphics{electoral-modelling-draft_files/figure-latex/rhovis-1} \end{center}
...
{\centering \includegraphics[width=0.6\linewidth]{electoral-modelling-draft_files/figure-latex/plotincomes-1} 
...
\begin{center}\includegraphics{electoral-modelling-draft_files/figure-latex/unnamed-chunk-2-1} \end{center}
